(function() {
    ...
    var na = this || self
      ...
      , Da = function(a, b) {
        ...
        for (var e; c.length && (e = c.shift()); )
            !c.length && oa(b) ? d[e] = b : d[e] && d[e] !== Object.prototype[e] ? d = d[e] : d = d[e] = {}
    }
      , l = function(a, b) {
        function c() {}
    ...
    : function(a, b) {
        if (pa(a))
            return pa(b) && 1 == b.length ? a.indexOf(b, 0) : -1;
    ...
    : function(a, b) {
        for (var c = a.length, d = Array(c), e = pa(a) ? a.split("") : a, f = 0; f < c; f++)
    ...
    var v = function(a, b, c) {
      ...
      , fb = function(a, b) {
        ...
        for (c.Ga.index = -1; null != c; ) {
            ...
            c.Ga.index++;
            c.Ga.index < d.length ? (d[c.Ga.index].Ga.index = -1,
            c = d[c.Ga.index]) : c = c.R
        }
    };
    var gb = function() {
        q.call(this);
    ...
    ;
    var $b = function(a) {
        if (a instanceof Zb && a.constructor === Zb && a.i === Yb)
            return a.g;
        ta(a);
    ...
    ec[" "] = ra;
    var fc = Ub("Opera"), gc = Ub("Trident") || Ub("MSIE"), hc = Ub("Edge"), ic = Ub("Gecko") && !(Pb(Rb.toLowerCase(), "webkit") && !Ub("Edge")) && !(Ub("Trident") || Ub("MSIE")) && !Ub("Edge"), jc = Pb(Rb.toLowerCase(), "webkit") && !Ub("Edge"), kc = function() {
        var a = na.document;
    ...
    if (uc = gc) {
        var vc;
        if (Object.prototype.hasOwnProperty.call(qc, "9"))
            vc = qc["9"];
        else {
            for (var wc = 0, xc = Ob(String(pc)).split("."), yc = Ob("9").split("."), zc = Math.max(xc.length, yc.length), Ac = 0; 0 == wc && Ac < zc; Ac++) {
                ...
                do {
                    var Dc = /(\d*)(\D*)(.*)/.exec(Bc) || ["", "", "", ""]
                      , Ec = /(\d*)(\D*)(.*)/.exec(Cc) || ["", "", "", ""];
                    if (0 == Dc[0].length && 0 == Ec[0].length)
                        break;
    ...
    ;
    var Ic = function(a, b) {
        a.S ? oa(void 0) ? b.call(void 0) : b() : (a.o || (a.o = []),
        a.o.push(oa(void 0) ? za(b, void 0) : b))
    };
    ...
    Sc.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Tc(a, b, d, e);
        -1 < g ? (b = a[g],
        c || (b.wb = !1)) : (b = new Qc(b,this.src,f,!!d,e),
        b.wb = c,
        a.push(b));
        return b
    }
    ...
    var Uc = function(a, b) {
      ...
      , Tc = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.Ya && f.listener == b && f.capture == !!c && f.Ab == d)
                return e
        }
        return -1
    };
    var Wc = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , gd = function(a, b, c, d, e) {
        if (ua(b))
            ...
            a.i--)))) : a && (a = cd(a)) && (c = Vc(a, b, c, d, e)) && hd(c)
    }
      , hd = function(a) {
        if (qa(a) || !a || a.Ya)
            return !1;
    ...
    G.prototype.play = function(a, b, c, d, e, f) {
        ...
        this.o ? (this.j ? this.j.connect(this.o) : d.connect(this.o),
        this.o.connect(this.H)) : this.j ? this.j.connect(this.H) : d.connect(this.H);
        this.j = null;
        d.loop = b;
        try {
            d.buffer = this.s.R
    ...
    var Kd = function(a) {
        ...
        this.s = !1;
        var b;
        a instanceof Kd ? (this.s = oa(void 0) ? void 0 : a.s,
        Ld(this, a.o),
        this.R = a.R,
        this.j = a.j,
        Md(this, a.S),
        this.i = a.i,
        Nd(this, Od(a.g)),
        this.H = a.H) : a && (b = String(a).match(rd)) ? (this.s = !1,
        Ld(this, b[1] || "", !0),
        this.R = Pd(b[2] || ""),
        this.j = Pd(b[3] || "", !0),
        Md(this, b[4]),
        this.i = Pd(b[5] || "", !0),
        Nd(this, b[6] || "", !0),
        this.H = Pd(b[7] || "")) : (this.s = !1,
        this.g = new Qd(null,this.s))
    };
    ...
    var Ld = function(a, b, c) {
      ...
      , Nd = function(a, b, c) {
        b instanceof Qd ? (a.g = b,
        Wd(a.g, a.s)) : (c || (b = Rd(b, Xd)),
        a.g = new Qd(b,a.s))
    }
      , Pd = function(a, b) {
      ...
      , Rd = function(a, b, c) {
        return pa(a) ? (a = encodeURI(a).replace(b, Yd),
    ...
    var ae = function(a, b) {
        ...
        if (qd(a.g.i, b)) {
            ...
            var c = a.g
              , d = b;
            qd(c.i, d) && (delete c.i[d],
            c.j--,
            c.g.length > 2 * c.j && pd(c))
        }
    }
      , be = function(a, b) {
        Zd(a);
    ...
    h.hb = function(a) {
        ...
        var b = [];
        if (pa(a))
            be(this, a) && (b = Qa(b, this.g.get($d(this, a))));
        else {
            a = this.g.hb();
            for (var c = 0; c < a.length; c++)
                b = Qa(b, a[c])
    ...
    var re = function(a, b) {
        for (var c = 1; c < arguments.length; c += 2) {
            var d = arguments[c]
              , e = arguments[c + 1]
              , f = a.style;
            f && d in f ? f[d] = e : d in a ? a[d] = e : le && f && "opacity" == d && (a.zoom = 1,
      ...
      , te = function() {
        var a = ["Itim"];
        window.WebFontConfig || (Da("WebFontConfig.google.families", a),
      ...
      , ye = function(a) {
        ...
        b && ((a = (a = a && !ge) || oe()) ? dc(b) : (a = window.top.location,
      ...
      , Je = function(a, b, c) {
        (ne() || oe()) && (a += "&ntp=1");
        b ? (Fe || ((b = document.getElementById("hplogoved")) ? Fe = b.getAttribute("data-ved") : qe() && be(de.g, "ved") && (Fe = de.g.get("ved"))),
        (b = Fe) && (a += "&ved=" + b)) : c && (Ge || ((b = document.getElementById("hplogoshareved")) ? Ge = b.getAttribute("data-ved") : qe() && be(de.g, "sved") && (Ge = de.g.get("sved"))),
        (b = Ge) && (a += "&ved=" + b));
    ...
    P.prototype.Qa = function() {
        ...
        0 < a && this.ha > a && (this.ya = ++this.ya % this.ma.length,
        this.ha -= a);
        this.s = this.ma[this.ya]
    }
    ;
    ...
    l(vj, qj);
      , uj = T([[1, 0, 1365, 49, 66], [1, 500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1, 443, 1375, 49, 66], [1, 211, 1376, 49, 66], [1, 846, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 950, 1377, 49, 66], [1, 347, 1378, 49, 66], [1, 52, 1388, 49, 66], [1, 104, 1388, 49, 66], [1, 156, 1388, 49, 66], [1, 552, 1394, 49, 66], [1, 604, 1397, 49, 66], [1, 604, 1397, 49, 66], [1, 604, 1397, 49, 66], [1, 263, 1401, 49, 66]], 83, 0, 0)
      , wj = 83 * rj.length
      , xj = 83 * uj.length;
    var yj = function() {
        this.g = []
    ...
    for (Dj in Aj)
        Bj[Cj++] = Aj[Dj];
    var Ej = [[Hb(0, -100, 0, 100)], null, [Hb(175, 0, -175, 0)], null, null, null, [Hb(25, -62.5, -25, 0), Hb(-25, 0, 31, -4), Hb(31, -4, -19, 58.5)], null, null], Fj = [new p(50,180), null, new p(320,240), null, null, null, new p(410,190), null, null], Gj = [null, null, null, null, K.g.Ic, null, K.g.Jc, null, null], Hj = function(a) {
        for (var b = {}, c = 0, d = Bj.length; c < d; c++)
            b[Bj[c]] = a[c];
        return b
    }, Ij = Hj("#0000ff #22ff43 #ff0000 #ffff00 #ff69b4 #4682b4 #ffd700 #800080 #ff9900".split(" ")), Jj = {}, Kj;
    for (Kj in Ij) {
        var Lj = Kj
          , Mj = Ij[Kj]
          , Nj = Mj;
    ...
    var Pj = Hj([[2, 3611, 0, 6, 20], [2, 2923, 161, 21, 19], [2, 2057, 171, 21, 6], [2, 2057, 149, 22, 19], [2, 2057, 127, 24, 19], null, [2, 2249, 90, 17, 19], null, null])
      , Qj = Hj(Ej)
      , Rj = Hj(Fj)
      , Sj = Hj(Gj);
    ...
    var Zj = mj([[Nh, 33, 5, [[$h, -2, -27]]]], 83)
      , Yj = mj([[[1, 1313, 102, 64, 65], 62, 47], [[1, 0, 1115, 82, 90], 47, 31], [[1, 653, 161, 149, 138], 29, 27], [[1, 999, 0, 159, 166], 28, 0]], 83)
      , ak = mj([[Nh, 33, 3, [[$h, -2, -25]]], [Nh, 33, 1, [[$h, -2, -23]]]], 83)
      , bk = mj([[Nh, 33, 5, [[$h, -3, -23]]], [[1, 835, 0, 161, 162], 27, 4], [[1, 468, 0, 182, 163], 2, 3]], 83)
      , ck = mj([[Th, 0, 1], [Th, 0, 1], [Th, 0, 1]], 83)
      , dk = mj([[Th, 0, 1], [Th, 0, 1], [Th, 0, 1], [Th, 0, 1], [Th, 0, 3], [Th, 0, -1], [Th, 0, -3], [Th, 0, -1], [Th, 0, 1], [Th, 0, 3], [Th, 0, -1], [Th, 0, -3], [Th, 0, -1], [Th, 0, 1], [Th, 0, 3]], 83)
      , ek = mj([[[1, 805, 165, 147, 154], 36, 0], [[1, 1161, 0, 149, 149], 47, 0], [[1, 1161, 152, 149, 145], 80, 0]], 83)
      , vk = 83 * bk.length
      , wk = 83 * ck.length
      , xk = 83 * dk.length
    ...
    var Gk = Qe.$()
      , Hk = 206 + Gh[4] / 2
      , Ik = S([[8, 2389, 0, 53, 74], [8, 2389, 77, 53, 74], [8, 2327, 80, 53, 74], [8, 2383, 154, 53, 74], [8, 2327, 157, 53, 74], [8, 2383, 231, 53, 74], [8, 2327, 234, 53, 74], [8, 2383, 308, 53, 74], [8, 2327, 311, 53, 74], [8, 2383, 385, 53, 74], [8, 2327, 388, 53, 74], [8, 2383, 462, 53, 74], [8, 2327, 465, 53, 74], [8, 0, 705, 53, 74], [8, 56, 705, 53, 74], [8, 112, 705, 53, 74], [8, 168, 705, 53, 74], [8, 224, 705, 53, 74], [8, 280, 705, 53, 74], [8, 336, 705, 53, 74], [8, 392, 705, 53, 74], [8, 448, 705, 53, 74], [8, 504, 705, 53, 74], [8, 560, 705, 53, 74]], 83, 545, 155, Hk - 1)
      , Jk = S([[6, 480, 0, 199, 123], [6, 682, 0, 199, 123], [6, 884, 0, 199, 123], [6, 1086, 0, 199, 123], [6, 1288, 0, 199, 123], [6, 1490, 0, 199, 123], [6, 1692, 0, 199, 123], [6, 1894, 0, 199, 123], [6, 2096, 0, 199, 123], [6, 2298, 0, 199, 123], [6, 2500, 0, 199, 123], [6, 2702, 0, 199, 123], [6, 2904, 0, 199, 123], [6, 3106, 0, 199, 123], [6, 3308, 0, 199, 123], [6, 3510, 0, 199, 123], [6, 3712, 0, 199, 123], [6, 3914, 0, 199, 123], [6, 4116, 0, 199, 123], [6, 4318, 0, 199, 123], [6, 4520, 0, 199, 123], [6, 4722, 0, 199, 123], [6, 4924, 0, 199, 123], [6, 4924, 0, 199, 123], [6, 4924, 0, 199, 123], [6, 5126, 0, 199, 123], [6, 5328, 0, 199, 123], [6, 5530, 0, 199, 123]], 83, 329, 81, 0)
      , Kk = S([Jh, [2, 2443, 0, 169, 158], [2, 2615, 0, 169, 158], [2, 2787, 0, 169, 158]], 83, Jh[3] / 2, 360 - Jh[4] / 2, 273)
    ...
    l(sl, qj);
    var el = T([[2, 2057, 199, 146, 148], [2, 2057, 199, 146, 148], [2, 2864, 218, 146, 148], [2, 3013, 218, 146, 148], [2, 3162, 218, 146, 148], [2, 3311, 218, 146, 148], [2, 3460, 218, 146, 148], [2, 1808, 236, 146, 148], [2, 1286, 252, 146, 148], [2, 1435, 262, 146, 148], [2, 1584, 262, 146, 148], [2, 1134, 275, 146, 148], [2, 2206, 280, 146, 148], [2, 2355, 280, 146, 148], [2, 2504, 280, 146, 148], [2, 0, 286, 146, 148], [2, 149, 286, 146, 148], [2, 298, 286, 146, 148], [2, 2653, 296, 146, 148], [2, 2653, 296, 146, 148], [2, 2653, 296, 146, 148]], 83, 0, -36)
      , dl = T([jh], 83, 14, -15)
      , fl = T([N, N, N, N, N, N, N, N, N, N, N, N, N, N, [1, 125, 293, 122, 134], [1, 250, 293, 122, 134], N, N, N, N, N, N, N, yg, yg, zg, zg, Ag, Ag, Bg, Bg, Cg, Cg, Dg, Dg, Eg, Eg, Fg, Fg, Gg, Gg, Hg, Hg, Ig, Ig, Jg, Jg, Kg, Kg, Kg, Kg, Kg], 83, 0, -9)
      , rl = T([[18, 0, 0, 184, 183], [18, 187, 0, 184, 183], [18, 374, 0, 184, 183], [18, 561, 0, 184, 183], [18, 561, 0, 184, 183], [18, 561, 0, 184, 183], [18, 748, 0, 184, 183], [18, 935, 0, 184, 183], [18, 1122, 0, 184, 183], [18, 1309, 0, 184, 183], [18, 1496, 0, 184, 183], [18, 1683, 0, 184, 183], [18, 1870, 0, 184, 183], [18, 2057, 0, 184, 183], [18, 2244, 0, 184, 183]], 83, -62, 38)
      , ql = S([[17, 471, 943, 105, 143], [17, 2170, 975, 105, 143], [17, 579, 1014, 105, 143], [17, 687, 1014, 105, 143], [17, 795, 1014, 105, 143], [17, 903, 1014, 105, 143], [17, 1011, 1014, 105, 143], [17, 1119, 1014, 105, 143], [17, 1227, 1014, 105, 143]], 83, -124, 65)
      , tl = 83 * el.length
      , ul = 83 * dl.length
      , vl = 83 * hl.length
      , wl = 83 * il.length
    ...
    sl.prototype.Bb = function() {
        0 >= this.ta && 1 != this.state && (this.j = Math.max(0, this.j - 1),
        U(this, 1, 0),
        this.Oa() ? (V(cl, 0),
        U(this, 16, 350),
        U(this, 0, this.Da),
    ...
    var Gl = function(a, b, c) {
      ...
      , Hl = function(a) {
        a.T ? t(a.T) : (a.T = new P(T([df], 0, -12, 37)),
        xb(a.T, new zj(a,.7,3)));
        a.T.i = -1;
        a.T.U = !1;
        r(a, a.T)
    ...
    var Pl = T([[2, 1957, 236, 83, 105]], 83, 0, 0)
      , Ql = T([[2, 1701, 522, 109, 91], [2, 1173, 538, 109, 91], [2, 1285, 538, 109, 91], [2, 1397, 543, 109, 91], [2, 1509, 543, 109, 91], [2, 1509, 543, 109, 91], [2, 1509, 543, 109, 91], [2, 1509, 543, 109, 91]], 83, 0, 0)
      , Rl = T([[2, 1998, 604, 97, 112], [2, 1813, 614, 97, 112], [2, 1621, 616, 97, 112], [2, 1129, 632, 97, 112], [2, 1229, 632, 97, 112], [2, 2728, 633, 97, 112], [2, 1329, 637, 97, 112], [2, 1429, 637, 97, 112]], 83, 0, 0)
      , Sl = T([[2, 1957, 236, 83, 105], [2, 1035, 312, 83, 105], [2, 1173, 426, 83, 105], [2, 1721, 616, 83, 105], [2, 1529, 637, 83, 105], [2, 196, 683, 83, 105], [2, 2098, 684, 83, 105], [2, 2184, 684, 83, 105], [2, 2184, 684, 83, 105]], 83, 0, 0);
    ...
    ;
    h.Bb = function(a) {
        return this.j[0] != a ? !1 : 6 == a ? (V(Nl, 19),
        !0) : this.Cb()
    }
    ;
    h.Cb = function() {
    ...
    Ol.prototype.update = function(a) {
        ...
        this.Oa() ? t(this) : 1 == this.state && (E(this),
        this.S = [],
        this.ka(2),
        V(Nl, 6),
        K.g.Tb.play(),
    ...
    Ol.prototype.La = function(a) {
        19 == a && this.R && this.g && !this.Oa() && (Vl(this),
        this.Cb())
    }
    ;
    ...
    l(Xl, Ol);
      , vm = T([[10, 0, 0, 204, 195], [10, 207, 0, 204, 195], [10, 414, 0, 204, 195], [10, 621, 0, 204, 195], [10, 828, 0, 204, 195], [10, 1035, 0, 204, 195], [10, 1035, 0, 204, 195]], 83, 0, 0)
      , wm = S([[10, 4140, 198, 204, 195], [10, 4347, 198, 204, 195], [10, 4554, 198, 204, 195], [10, 4761, 198, 204, 195], [10, 4968, 198, 204, 195], [10, 5175, 198, 204, 195], [10, 5175, 198, 204, 195], [10, 5175, 198, 204, 195], [10, 5175, 198, 204, 195]], 83, 0, 0)
      , xm = 83 * wm.length;
    ...
    var Dm = function(a, b, c, d, e, f) {
      ...
      , Gm = function(a) {
        ...
        Em(a.o, a.j, function(c) {
            "mouseup" == c ? a.Ba() : "mouseover" == c ? (a.ka(1),
            a.T(!0),
            document.getElementById("hplogo").title = a.ta) : "mouseout" == c && (a.ka(0),
            a.T(!1),
    ...
    Lm.prototype.update = function(a) {
        ...
        var b = 2;
        this.W ? this.j += 320 > this.o ? -.5 : .5 : (b -= .2,
        this.j += .2 * (1 - 2 * Math.random()),
        this.S += .2 * (1 - 2 * Math.random()));
        ...
        if (100 == this.o || 540 == this.o)
            this.j = this.W ? 0 : -this.j;
        if (110 == this.s || 250 == this.s)
            this.S = -this.S
    }
    ;
    ...
    var Tm = function() {
        ...
        r(this, this.j);
        for (var a = 0; 50 > a; a++) {
            for (var b = new Rm(8 + a * a * .002,3E3), c = 0; c < 2 * a; c++)
                b.update(17);
            b.i = -1;
            r(this, b)
        }
    ...
    Rm.prototype.update = function(a) {
        this.j += a / this.s;
        var b = this.j % 1;
        b > 2 / 3 ? (a = 100 - 300 * (b - 2 / 3),
        b = 56 - 168 * (b - 2 / 3)) : b > 1 / 3 ? (a = 300 * (b - 1 / 3),
        b = 113 - 168 * (b - 1 / 3)) : (a = 0,
        b *= 339);
        v(this, a, b)
    }
    ...
    var en = function(a, b) {
      ...
      , fn = function(a) {
        ...
        30 < a.i && a.V && (b - a.V >= 1.05 * a.s ? a.j++ : a.j >>= 1,
        20 < a.j && (a.s = Math.min(50, 1.2 * a.s),
        a.j = 0));
        a.V = b
    };
    ...
    mn.prototype.Ha = function() {
        ...
        Em(this.S, this.R, function(b) {
            ...
            case "mouseout":
                Pm(a.H),
                a.g.S = [],
                xb(a.g, new W(a.g.j,200,a.g.j.va,0))
            }
        });
        r(ln.g, this.i)
    }
    ...
    l(on, qj);
    var pn = S([Yh, Yh, Yh, Yh, Yh, Yh, Zh, [1, 85, 1196, 81, 74], [1, 169, 1196, 81, 74], Zh, Zh], 83, 0, 0)
      , qn = T([[1, 648, 1196, 81, 74], [1, 337, 1200, 81, 74], [1, 732, 1203, 81, 74], [1, 816, 1203, 81, 74]], 83, 0, 0)
      , rn = T([[17, 2290, 797, 64, 84]], 83, 0, -2)
      , sn = T([[17, 2290, 884, 64, 84], [17, 387, 1134, 64, 84]], 83, 0, -2)
      , tn = S([[17, 1656, 1014, 100, 113], [17, 1759, 1014, 100, 113], [17, 1862, 1014, 100, 113], [17, 1965, 1014, 100, 113], [17, 360, 1018, 100, 113], [17, 0, 1032, 100, 113]], 83, 0, -2)
      , un = S([O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, Vh, Vh, Wh, Wh, Wh, Wh, Wh, Wh, Vh, Vh], 83, 0, 0)
      , vn = T([[17, 792, 1160, 63, 82]], 83, 0, 0)
      , wn = T([[17, 858, 1160, 63, 82], [17, 924, 1160, 63, 82]], 83, 0, 0)
      , xn = S([[17, 2256, 0, 104, 113], [17, 2256, 116, 104, 113], [17, 2256, 232, 104, 113], [17, 1335, 1014, 104, 113], [17, 1442, 1014, 104, 113], [17, 1549, 1014, 104, 113]], 83, 0, 0)
      , yn = S([th, th, th, th, uh, uh, vh, vh, wh, wh, xh, xh, xh, xh, xh, xh, xh, xh, xh, xh, wh, wh, vh, vh, uh, uh, th, th, th, th], 83, 0, 0)
      , zn = T([[1, 1105, 1073, 102, 87], [1, 1210, 1073, 102, 87], [1, 480, 1075, 102, 87], [1, 585, 1095, 102, 87], [1, 690, 1106, 102, 87], [1, 375, 1110, 102, 87]], 83, 0, 0)
      , An = T([[17, 990, 1160, 61, 84]], 83, 0, -6)
      , Bn = T([[17, 1054, 1160, 61, 84], [17, 1118, 1160, 61, 84]], 83, 0, -6)
      , Cn = S([[17, 2068, 1122, 92, 113], [17, 1335, 1130, 92, 113], [17, 1430, 1130, 92, 113], [17, 1525, 1130, 92, 113], [17, 1620, 1130, 92, 113], [17, 1715, 1130, 92, 113]], 83, 0, -6)
      , Dn = S([nh, nh, oh, oh, ph, ph, qh, qh, rh, rh], 83, 0, 0)
      , En = T([[1, 965, 1163, 82, 78], [1, 1050, 1163, 82, 78], [1, 1135, 1163, 82, 78], [1, 1220, 1163, 82, 78]], 83, 0, 0)
      , Fn = S([[17, 2278, 975, 76, 75], [17, 1986, 1130, 76, 75], [17, 103, 1140, 76, 75], [17, 182, 1140, 76, 75], [17, 0, 1148, 76, 75]], 83, 0, 1)
      , Gn = T([[17, 1898, 1130, 85, 81], [17, 299, 1134, 85, 81]], 83, 0, 1)
      , Hn = S([[17, 2068, 1014, 95, 105], [17, 103, 1032, 95, 105], [17, 201, 1032, 95, 105], [17, 463, 1089, 95, 105], [17, 2166, 1121, 95, 105], [17, 2264, 1121, 95, 105]], 83, 0, 1)
      , In = 83 * Gn.length;
    var Jn = function() {
        q.call(this);
    ...
    l(Sn, qj);
    var Pn = [Eh, [2, 1286, 211, 42, 31], [2, 1621, 543, 42, 31], [2, 1813, 575, 42, 31], [2, 1621, 577, 42, 31], [2, 2828, 633, 42, 31], [2, 2828, 667, 42, 31], [2, 2432, 684, 42, 31], [2, 2677, 703, 42, 31], Fh]
      , Rn = [[2, 1985, 719, 41, 38], [2, 2029, 719, 41, 38], [2, 1721, 724, 41, 38], [2, 1765, 724, 41, 38], [2, 1809, 729, 41, 38], [2, 1853, 729, 41, 38], [2, 1615, 731, 41, 38], [2, 1659, 731, 41, 38], [2, 2677, 737, 41, 38], [2, 1529, 745, 41, 38], [2, 1116, 747, 41, 38], [2, 1160, 747, 41, 38]]
      , Qn = 1E3 / 12
      , Tn = Pn.length * Qn
      , Un = Rn.length * Qn
      , Vn = Eh[3];
    ...
    Sn.prototype.ka = function(a) {
        this.state == a || 3 == this.state && 2 == a || 4 == this.state && 1 == a || (Wn[a] && Xn[this.state] ? (E(this),
        U(this, 2, Tn),
        a = 3) : Xn[a] && Wn[this.state] && (E(this),
        U(this, 0, Un),
        a = 4),
    ...
    ho.prototype.La = function(a, b) {
        !this.g || 5 != a && 11 != a ? this.g && 0 < this.U && (8 == a || 17 == a) ? (E(this.s),
        yb(this.s, new W(this.T,200,.6,0)),
        A(this.s, new W(this.j,200,1,0)),
        this.ma()) : 13 == a && (this.ya = this.o) : (E(this.s),
        this.s.S = [],
        this.U++,
        2 <= this.U ? (2 == this.U ? (xb(this, new W(this.j,200,0,1)),
        xb(this, new W(this.T,200,0,.6))) : (this.j.va = 1,
        this.T.va = .6),
        this.j.g = !0,
        this.j.o = " x " + this.U,
        wb(this.s, 500),
        yb(this.s, new W(this.T,500,.6,0)),
        A(this.s, new W(this.j,500,1,0,za(this.ma, this)))) : D(this.s, 1E3, za(this.ma, this)),
    ...
    l(no, Ol);
    var lo = S([[2, 2990, 709, 78, 63], [2, 3071, 709, 78, 63], [2, 3152, 709, 78, 63], Ch, Ch, Ch, Ch, Ch], 83, 0, 0)
      , mo = T([[2, 1337, 68, 78, 63], [2, 1808, 143, 78, 63], [2, 2104, 350, 78, 63], [2, 1875, 387, 78, 63], [2, 687, 699, 78, 63], [2, 768, 699, 78, 63], [2, 2596, 703, 78, 63], [2, 2828, 709, 78, 63], [2, 2909, 709, 78, 63], [2, 2909, 709, 78, 63], [2, 2909, 709, 78, 63], [2, 2909, 709, 78, 63]], 83, 0, 0);
    ...
    po.prototype.La = function(a) {
        20 != a || this.s && !this.s.Oa() || (a = Uj(190, 295),
        a = new no(a.x,a.y),
        Tl(a),
        x(a, Uk()),
        r(this.j, a),
    ...
    var Bo = [5, 6, 7, 8, 9, 11, 12, 16]
      ...
      , Ho = function(a) {
        ...
        b = [];
        for (var c in Fo)
            Fo.hasOwnProperty(c) && b.push(c + ":" + Fo[c]);
        for (Je(b.join(","), 10 == a, 0 <= Bo.indexOf(a)); 0 < Go.length; )
            delete Fo[Go.pop()];
        Eo || 0 != a || (qe() ? "1" == de.g.get("ccta") : pe() && !ne() && !oe() || me && je) || (Eo = !0,
        Ho(10))
    };
    var Io = function(a) {
        ld.call(this);
    ...
    var No = []
      ...
      , Po = function(a, b, c, d, e, f) {
        if (ua(c))
            ...
            d = ad(d),
            e = !!e,
            c = Oc(b) ? Vc(b.i, String(c), d, e, f) : b ? (b = cd(b)) ? Vc(b, c, d, e, f) : null : null,
            c && (hd(c),
            delete a.i[c.key])
    }
      , Qo = function(a) {
    ...
    var Ro = function(a, b, c, d, e) {
        ...
        this.W = c;
        this.U = d;
        e && (this.j && Po(this, this.j, "action", this.H),
        e && (this.j = new Io(e),
    ...
    var Yo = yj.$()
      , Zo = function(a, b, c) {
        ...
        this.ma = Dm(a, gi, gi, function() {
            window.location = "http://www.google.com/doodles/_SHARE?description=" + encodeURIComponent(String(Wo(d.o))) + "&url=" + encodeURIComponent(String(Vo()))
        }, L("Share"));
    ...
    Zo.prototype.Ha = function() {
        this.R = this.S = !1;
        this.s || (this.s = new yo(this.ha,L("Happy Halloween!"),466,85,"white","center","'Itim', sans-serif",36,20,244,1,!1),
        r(this.i, this.s));
        r(Vm.$().g, this.i);
    ...
    Zo.prototype.update = function() {
        return this.S ? (V(Yo, 14),
        Z.state) : this.R ? (V(Yo, 15),
        13) : 0
    }
    ;
    ...
    var dp = function(a) {
      ...
      , gp = function(a) {
        ...
        a.s ? document.addEventListener(a.s, a.i, !1) : b && b.registerPageVisibilityListener && (google.doodle || (google.doodle = {}),
    ...
    var op = function(a, b, c, d) {
      ...
      , np = function(a) {
        for (var b = a.g && a.g.i.Xb() ? "pointer" : "default", c = 0, d; d = a.ya[c]; c++)
            re(d, "cursor", b)
    }
      , pp = function(a, b) {
        this.i = a;
    ...
    var vo = function(a) {
      ...
      , vp = function(a) {
        ...
        if (3 < d.x / d.y)
            return [2, m];
        if (3 > a.Na && (3 < d.y / d.x && 2 > a.ma || 5 < d.y / d.x && 4 > a.ma))
            return [0, m];
        var u = [[0], [0, 0], [0, 0, 0]];
        if (0 < d.y)
            for (var C = 0, Q = a.j.length; C < Q - 1; C++)
                for (var J = a.Qa[C], B = (a.j[C][1] - f) / d.y, R = 0; R < u.length; R++)
                    u[R][Math.floor(Ta(B * (R + 1), 0, R))] += J;
        d = Ml(new Ll(b.x - c.x,b.y - c.y));
        C = e / 3;
        if (d < C && (m = 1 - Ta(d / C, 0, 1),
        u[1][0] > u[1][1] && !w))
            return [4, m];
        if (3 == a.ma || u[2][1] > .4 * u[0][0] && (c.y < f + k && b.y > g - k || b.y < f + k && c.y > g - k))
            return [6, m];
        e /= 6;
        m = Ya(a.ya, c);
        f = Xa(m);
        k = Ya(b, a.ya);
        g = Xa(k);
        if (f > e && g > e && (m = Ua(m.x, m.y),
        k = Ua(k.x, k.y),
        270 < m && 90 > k || 180 < m && 270 > m && 90 < k && 180 > k))
            return m = Ta(1 - Math.abs(f - Math.min(f, g)) / f, 0, 1),
            [1, m];
        f = Ya(a.ha, c);
        c = Xa(f);
        b = Ya(b, a.ha);
        a = Xa(b);
        return c > e && a > e && (e = Ua(f.x, f.y),
        b = Ua(b.x, b.y),
        90 > e && 270 < b || 90 < e && 180 > e && 180 < b && 270 > b) ? (m = Ta(1 - Math.abs(c - Math.min(c, a)) / c, 0, 1),
        [3, m]) : null
    };
    up.prototype.ra = function(a) {
        ...
        if (this.W || c)
            ...
            this.Ea && this.j.length) {
                (c = vp(this)) ? (b = Jj[c[0]],
                c = c[1],
                c = Ta(c, 0, 1),
                b = "rgb(" + [Math.round(Db[0] + c * (b[0] - Db[0])), Math.round(Db[1] + c * (b[1] - Db[1])), Math.round(Db[2] + c * (b[2] - Db[2]))].join() + ")") : b = "white";
                a.strokeStyle = b;
                a.lineWidth = 10;
                a.lineCap = "round";
                a.beginPath();
                ...
                b = this.j.length;
                for (c = 0; c < b - 2; c++)
                    a.quadraticCurveTo(this.j[c][0], this.j[c][1], (this.j[c][0] + this.j[c + 1][0]) / 2, (this.j[c][1] + this.j[c + 1][1]) / 2);
        ...
        case "mousemove":
            if (8 > b || 8 > c || 632 < b || 352 < c)
                ...
                if (0 < a) {
                    ...
                    var d = a[1] - c
                      , e = Math.abs(d);
                    0 == this.Da && 3.75 < e ? (this.Na++,
                    this.Da = d / e) : 0 > d * this.Da ? (this.s += e,
                    15 < this.s && (this.Na++,
                    this.s = 0,
                    this.Da = d / e)) : 0 < d * this.Da && (this.s -= e,
                    -7.5 > this.s && (this.s = 0));
                    d = a[0] - b;
                    e = Math.abs(d);
                    0 == this.ta && 3.75 < e ? (this.ma++,
                    this.ta = d / e) : 0 > d * this.ta ? (this.o += e,
                    15 < this.o && (this.ma++,
                    this.o = 0,
                    this.ta = d / e)) : 0 < d * this.ta && (this.o -= e,
                    -7.5 > this.o && (this.o = 0));
                ...
                c > this.ha.y && (this.ha.x = b,
                this.ha.y = c);
                c < this.ya.y && (this.ya.x = b,
                this.ya.y = c);
                this.U = new p(b,c);
                V(rp, 9)
            }
    ...
    Mp.prototype.Ha = function() {
        Z = Tk[this.i];
        Nb(Xk(), ra);
        Np ? oj(Np, Z.background) : (Np = new P(Z.background),
        Np.i = -1,
        v(Np, 320, 180),
        r(Lp.g, Np));
    ...
    ;
    var qq = function(a) {
        a.i && (a.j ? (pq.call(document),
        a.j = !1) : (a.R.call(a.g),
        a.s && (window.screen.lockOrientation && window.screen.lockOrientation(a.s),
        window.screen.orientation && window.screen.orientation.lock && window.screen.orientation.lock(a.s)["catch"](ra))))
    }
      , tq = function(a, b, c, d) {
        var e = rq;
        d = void 0 === d ? ra : d;
    ...
    Bq.prototype.update = function() {
        rq.update();
        var a = Ao();
        (document[vq] && (this.W.width != a.width || this.W.height != a.height) || this.ya) && 0 < parseInt(getComputedStyle(this.j).width, 10) && (this.W = a,
        Aq(this),
        this.ya = !1)
    }
    ;
        ...
        if (a.i && eo() && !a.j) {
            ...
            if (oe()) {
                ...
                window.addEventListener("message", function(C) {
                    "resizeComplete" === C.data.Zc && (null !== this.Db && (clearTimeout(this.Db),
                    this.Db = null),
                    e || (e = !0,
                    b()))
                })
    ...
    var Lq = function(a, b) {
        window.google && google.doodle && (b && Da("google.doodle.cpDestroy", b),
    ...
    var Nq = function(a, b) {
        ...
        this.V = Ba();
        this.H = null;
        eo() && (this.H = new Gq(a,c),
        Ic(this, Aa(Jc, this.H)),
        co() || (nn(this.H, function() {
            var g = an.$();
            g.R = !0;
            hn(g)
        }),
